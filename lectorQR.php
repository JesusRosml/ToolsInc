...
<body>
                    ...
                    <div class="container-cards"><!--container-cards -->
                        <div class="container-infUser">
                            <div class="title-user">
                                ...
                                <p>Nombre: <em></em></p>
                                <p>Fecha del prestamo: <em></em></p>
                                <p>Fecha de finalizacion: <em></em></p>
                            </div>
                        ...
                        <!-- Los datos los meteras en <em> -->
                                    <p>ID: <em></em></p>
                                    <p>Numero telefonico: <em></em></p>
                                    <p>Correo electronico: <em></em></p>
                                    <p>Puesto de trabajo: <em></em></p>
                                    <p>Fecha de registro: <em></em></p>
                                </article>
                            </details>
                    ...
                    <div class="containerprincipal"> <!-- Con estilo -->
                      ...
                      <div class="containerhijo2">
                        ...
                        <div class="require-text">
                            <input class="modicar" type="text" placeholder="Introduzca la cantidad de herramientas">
                            <input type="text" placeholder="Introduzca la fecha">
                        ...
                        <div class="container-trabajador">
                            ...
                            <div class="qrHerramientasTwo">
                                ...
                                <div class="containerSeguro">
                                    <button id="buttonSeguro">Confirmar herramientas</button>
                                </div>
    ...
    <script src="assets/scripts/appLector.js"></script>
</body>
</html>